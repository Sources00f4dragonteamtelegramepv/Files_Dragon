...
if DevSOFI:get(Dragon.."SOFI:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevSOFI:sadd(Dragon.."SOFI:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevSOFI:get(Dragon.."SOFI:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DragonName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DragonName then 
DragonNames = DevSOFI:smembers(Dragon.."SOFI:Mute:Names"..msg.chat_id_) or ""
if DragonNames and DragonNames[1] then 
for i=1,#DragonNames do 
if DragonName:match("(.*)("..DragonNames[i]..")(.*)") then 
...
DevSOFI:set(Dragon.."SOFI:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevSOFI:del(Dragon.."SOFI:Lock:MuteNames"..msg.chat_id_)
end
end
end
